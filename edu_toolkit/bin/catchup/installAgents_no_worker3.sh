...
AgentInstallation_LOG="`date +%F`-InstallCMAgent-No-worker3.log"
...
echo
echo "Installing CM Agent to all machines in parallel."
echo
...
echo
echo "Configuring all agents to find the CM server" 
echo
...
echo "Starting CM Agent on all machines in parallel." 
