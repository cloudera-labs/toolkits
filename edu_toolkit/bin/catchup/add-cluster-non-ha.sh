...
# ------------------------------[ Documentation ]----------------------------------------
#
# This script performs the installation of CM agents, cloudera mangement services, 
...
#		Only contine to next function if cloudera manager is running and reacheable
#
...
#		Only continue to next funciton if CMS starts up, and is okay 
#     
...
#		- Zookeeper
#
# (7) Final configurations after template import: Add local directory settings for HDFS and YARN
# 
...
install_cm_agents(){
    ...
    ssh training@cmhost -o StrictHostKeyChecking=no /home/training/training_materials/admin/scripts/catchup/installAgents_no_worker3.sh
...
#	curl -X PUT -H "Content-Type:application/json" -u admin:admin 'http://localhost:7180/api/v12/cm/deployment' -d @/home/training/config/working/mgmt-services.json
...
apply_cm_template(){
	...
	passJson="-d @/home/training/training_materials/admin/scripts/catchup/json/admin20_PROD.json"
