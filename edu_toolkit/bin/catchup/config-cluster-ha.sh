...
#
#
# (7) Configure command line tools to use CDH7.1.2 as default
#
#
...
apply_cm_template(){
	...
	passJson="-d @/home/training/training_materials/admin/scripts/catchup/json/admin20_PROD_HA.json"
