...
# Describe function.
	...
	sudo keytool -import -keystore ${WORK_DIR}/jssecacerts -storepass ${PASSWORD} -alias cmrootca-0 -file /var/lib/cloudera-scm-agent/agent-cert/cm-auto-in_cluster_ca_cert.pem -noprompt
}
